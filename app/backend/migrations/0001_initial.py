...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('Giving Rides', 'Giving Rides'), ('Preparing Meals', 'Preparing Meals'), ('Shopping', 'Shopping'), ('Childcare', 'Childcare'), ('Visits', 'Visits'), ('Coverage', 'Coverage'), ('Miscellaneous', 'Miscellaneous'), ('Event', 'Event')], default='Event', max_length=20)),
                ('name', models.CharField(max_length=30)),
                ('notes', models.CharField(max_length=200)),
                ('start_date', models.CharField(max_length=30)),
                ('end_date', models.CharField(max_length=30)),
                ('repeat', models.CharField(choices=[('Never', 'Never'), ('Weekly', 'Weekly'), ('Custom', 'Custom')], default='Never', max_length=6)),
                ('weekly_repeat_dates', models.CharField(blank=True, default='', max_length=150)),
                ('custom_repeat_dates', models.CharField(blank=True, default='', max_length=150)),
                ('est_hours', models.CharField(blank=True, default='', max_length=10)),
                ('est_minutes', models.CharField(blank=True, default='', max_length=20)),
                ('volunteers_needed', models.CharField(blank=True, default='', max_length=20)),
                ('volunteers_signed_up', models.CharField(blank=True, default='', max_length=20)),
                ('display_type', models.CharField(blank=True, default='Event', max_length=12)),
                ('pickup_time', models.CharField(blank=True, default='', max_length=150)),
                ('pickup_between', models.CharField(blank=True, default='', max_length=150)),
                ('arrive_time', models.CharField(blank=True, default='', max_length=150)),
                ...
                ('dietary_restrictions', models.CharField(blank=True, choices=[('None', 'None'), ('Vegetarian', 'Vegetarian'), ('Kosher', 'Kosher'), ('Nut-free', 'Nut-free'), ('Lactose-free', 'Lactose-free'), ('Wheat-free', 'Wheat-free'), ('Gluten-free', 'Gluten-free'), ('Soy-free', 'Soy-free'), ('Sugar-free', 'Sugar-free'), ('Low-fat', 'Low-fat'), ('Low-carb', 'Low-carb'), ('Low-salt', 'Low-salt'), ('Other (see notes)', 'Other (see notes)')], default='', max_length=500)),
                ('delivery_between', models.CharField(blank=True, default='', max_length=150)),
                ('delivery_location', models.CharField(blank=True, default='', max_length=150)),
                ('start_time', models.CharField(blank=True, default='', max_length=150)),
                ('end_time', models.CharField(blank=True, default='', max_length=150)),
