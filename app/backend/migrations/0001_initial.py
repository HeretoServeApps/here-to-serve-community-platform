# Generated by Django 3.0.7 on 2020-12-09 03:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('activity_type', models.CharField(choices=[('Giving Rides', 'Giving Rides'), ('Preparing Meals', 'Preparing Meals'), ('Shopping', 'Shopping'), ('Childcare', 'Childcare'), ('Laundry', 'Laundry'), ('House Cleaning', 'House Cleaning'), ('Pet Care', 'Pet Care'), ('Visits', 'Visits'), ('Miscellaneous', 'Miscellaneous'), ('Occasion', 'Occasion')], default='Occasion', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('general_content', tinymce.models.HTMLField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.CharField(default='January', max_length=12)),
                ('year', models.CharField(default='2020', max_length=4)),
                ('time', models.CharField(default='12:00 PM', max_length=8)),
                ('title', models.CharField(default='', max_length=100)),
                ('photo', models.FileField(max_length=500, upload_to='')),
                ('description', models.CharField(default='', max_length=256)),
                ('community', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.Community')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time', models.CharField(max_length=100)),
                ('community', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.Community')),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.CustomSection')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
