# Generated by Django 3.0.4 on 2020-06-17 09:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=128)),
                ('general_content', tinymce.models.HTMLField()),
                ('community', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.Community')),
                ('discussion_posts', models.ManyToManyField(to='backend.DiscussionPost')),
                ('resources', models.ManyToManyField(to='backend.Resource')),
            ],
        ),
        migrations.CreateModel(
